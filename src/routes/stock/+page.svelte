...
<div class="space-y-10">
  <header class="flex flex-col md:flex-row md:items-end justify-between gap-6">
    ...
    <a href="https://shop.rosenbauer.com/?srsltid=AfmBOoqsh0uIXWZ0tRFYJDfgBkq0SNU9FDkgfupBdq1yPUSKCEhWlSL5" target="_blank" rel="noopener noreferrer" class="bg-[var(--color-primary)] text-white px-6 py-3 rounded-[var(--radius-md)] font-bold uppercase tracking-wide text-xs shadow-lg">
